...
public class ParticleSystem
{
    ...
    public void init(FloatP pos)
    {
        ...
        System.out.println ("PSys:1 - Particles: " + particles.size() + " - Coords: " + randPointX + " , " + randPointY);
    ...
    public void init2(FloatP pos)
    {
        ...
        System.out.println ("PSys:2 - Particles: " + particles.size() + " - Coords: " + pos.x + " , " + pos.y);
    ...
    public void init3(FloatP pos)
    {
        ...
        // Console: Which System, Output Coords
        System.out.println ("PSys:3 - Particles: " + particles.size() + " - Coords: " + pos.x + " , " + pos.y);
